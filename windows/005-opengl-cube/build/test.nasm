...
MainWindow_1.cbClsExtra: dd 0 ; int = NULL
MainWindow_1.cbWndExtra: dd 0 ; int = NULL
...
MainWindow_1.hbrBackground: dq 0 ; HBRUSH = NULL
MainWindow_1.lpszMenuName: dq 0 ; LPCSTR = NULL
MainWindow_1.lpszClassName: dq Generic__uuid ; LPCSTR 
MainWindow_1.hIconSm: dq 0 ; HICON = NULL
...
; get pointers to stdout/stderr pipes
    ...
    mov dword ecx, -12; 1st: DWORD nStdHandle
call GetStdHandle
    ...
    ; MS __fastcall x64 ABI
    sub rsp, 40 ; allocate shadow space
    mov dword ecx, -11; 1st: DWORD nStdHandle
call GetStdHandle
...
; dynamically load library at runtime
    ...
    ; MS __fastcall x64 ABI
    sub rsp, 40 ; allocate shadow space
    mov qword rcx, LoadLibraryA__opengl32; 1st: 
call LoadLibraryA
...
call DefWindowProcA
    mov qword [WndProc__return], rax ; return LRESULT
    add rsp, 40 ; deallocate shadow space
    call GetLastError__epilogue_check
