...
#ld -s test.obj "C:\WINDOWS\System32\kernel32.dll" "C:\WINDOWS\System32\user32.dll" -o "F:\Desktop\tmp\winasm-2\Assembly\windows\004-opengl\test.exe"
#ld -s test.obj -L"C:\Program Files\PellesC\Lib\Win64" kernel32.lib user32.lib -o "F:\Desktop\tmp\winasm-2\Assembly\windows\004-opengl\test.exe"
